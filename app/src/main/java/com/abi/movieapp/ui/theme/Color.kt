package com.abi.movieapp.ui.theme
...
val BackgroundBrush = Brush.linearGradient(colors = listOf(TextFieldBorderColor, TextFieldBorderColor))
val WhiteGradientBrush = Brush.linearGradient(colors = listOf(Color.White, Color.White))
